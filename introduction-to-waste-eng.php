...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <section class="safeFoodl4_banner no-print" id="option1" data-scrl="The problem with waste">
            <div class="container-fluid no-print">
                <div class="row px-4">
                    <div class="col-md-6">
                        <div class="banner_l4_title Banner_l3_title cst_mar">
                            <h1 class="banner_title" style="    margin-top: -4rem;">THE PROBLEM<br>WITH WASTE</h1>

                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="banner_l3_img energy_banner">
                            <img src="assets/images/safe_food/w1e.svg" class="img-fluid pl-5">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="didyouknow_contents waste_foot_l3 no-print energy_mar" id="option2" data-scrl="Did you know that...">
                ...
                <div class="row border-top">
                    ...
                    <div class="col-md-6">
                        <div class="didyouknow_2culumn">
                            ...
                            <h4>used coffee grinds<br>can be put into the garden<br>as compost </h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section3-inners no-print" id="option3" data-scrl="The big issue">
        ...
        <?php include "includes/scroll/scroll8.php"; ?>
        </section>
        ...
        <section class="section3-inners no-print" id="option5" data-scrl="The greater impact">
            <div class="section3-inner align-normal big_issues">
                <div class="left-content">
        ...
        <section class="section4 padr-60px no-print mt-4" id="option6" data-scrl="Steps to reduce waste">

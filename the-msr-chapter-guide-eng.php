...
<body class="">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<div class="collapse navbar-collapse" id="main_nav">
					<ul class="navbar-nav">
						...
						<li class="nav-item dropdown" id="myDropdown">
							<a class="nav-link header-brand-link dropdown-toggle header-brand-link3" href="the-msr-chapter-guide-eng.php" target="_self" data-bs-toggle="dropdown">The MSR Chapter Guide <span class="i1"><i class="fa fa-chevron-down"></i></span> </a>
				...
				<div class="d-flex">
					...
					<div class="custom__select top-mar-less">
						<select>
							<option id="lange" value="the-msr-chapter-guide-eng.php" selected>ENG</option>
							<option id="langd" value="the-msr-chapter-guide-deu.php">DEU</option>
						</select>
					</div>
	...
	<div class="page-2_stage">
		...
		<map name="image-map">
			...
			<area id="safe_food_id" coords="1426,89,1628,309" shape="rect">
			<area id="energy_id" coords="1913,115,2178,409" shape="rect">
			<area id="waste_id" coords="1942,483,2174,728" shape="rect">
			<area id="plastic_waste_id" coords="1899,815,2235,1122" shape="rect">
			<area id="food_waste_id" coords="963,1092,1230,1367" shape="rect">
			<area id="Sustainable_Menu_id" coords="411,989,638,1234" shape="rect">
			<area id="social_id" coords="21,572,258,841" shape="rect">
...
<div class="main_scroll">
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			...
			<div class="header">
				<h2>How to save water in your restaurant</h2>
				<p>Water runs your business. As a restaurant owner, you require a large amount of it before, during and after the service, from cooking and steaming to washing and sanitizing. But water does not only cost you money, it is also precious. Show your customers that you take responsibility and adapt water saving behavior with long-term benefits for you and the environment.<br><strong>Comprehensive guides and tools, coming soon.</strong></p>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const storageKey = 'activeImageIndex';

  // Check if activeImageIndex exists in local storage
  let activeImageIndex = parseInt(localStorage.getItem(storageKey));
  if (isNaN(activeImageIndex) || activeImageIndex < 0 || activeImageIndex >= images.length) {
    // Set initial value to middle image
    activeImageIndex = Math.floor(images.length / 4);
  }
  ...
  container.scrollLeft = images[activeImageIndex].offsetLeft - container.offsetWidth / 4;
  ...
  images.forEach((image, index) => {
    image.addEventListener('click', () => {
      ...
      // Set new active image index and update local storage
      activeImageIndex = index;
      localStorage.setItem(storageKey, activeImageIndex);

      // Add active class to new active image
      images[activeImageIndex].classList.add('active');

      // Scroll to new active image
      container.scrollLeft = images[activeImageIndex].offsetLeft - container.offsetWidth / 4;
    });
  });
});

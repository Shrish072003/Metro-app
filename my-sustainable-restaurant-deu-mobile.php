...
<?php include "includes/header-deu.php"; ?>
    ...
    <div class="sec-banner b6" title="">
        <div class="blink__text arrow" onclick="toggleTooltip()">Klicke hier</div>
        <div class="tooltip_wrapper" id="tooltipWrapper">
            <div class="">
                <p class="tooltip-content">
                    <span>ie in der Natur besteht ein Restaurant aus verschiedenen Bausteinen. Unser Ziel ist es, Sie dabei zu unterstützen, ein profitables Geschäft zu führen und gleichzeitig einen positiven Einfluss auf Ihre Gemeinschaft und die Umwelt zu haben. Eine von drei Mahlzeiten wird außer Haus verzehrt, weshalb lhre Arbeit einen großen Einfluss hat.

Mein nachhaltiges Restaurant“ führt Sie Schritt für Schritt zu mehr Nachhaltigkeit in Ihrem Betrieb.</span>
                    <a target="_parent" href="the-msr-chapter-guide-deu.php" class="click-cta">MNR betreten</a>
...
<?php include "includes/footer-eng.php"; ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var eng_page_path = "my-sustainable-restaurant-deu-mobile.php";
            var deu_page_path = "my-sustainable-restaurant-eng-mobile.php";
            //manipulation
...
<script>
    ...
    function redirectToDesktopPage() {
        if (isDesktopDevice()) {
            window.location.href = "my-sustainable-restaurant-deu.php";
        }
    }

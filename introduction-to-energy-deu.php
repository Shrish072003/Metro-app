...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <section class="safeFoodl4_banner no-print" id="option1" data-scrl="Wie Sie in Ihrem Restaurant weniger Energie verbrauchen und damit Kosten sparen">
            <div class="container-fluid no-print">
                <div class="row px-4">
                    <div class="col-md-6">
                        <div class="banner_l4_title Banner_l3_title cst_mar" style="padding-left: 3rem;">
                            <h1 class="banner_title">Wie Sie in Ihrem Restaurant weniger Energie verbrauchen<br>und damit Kosten sparen</h1>
        ...
        <section class="section4 padr-60px no-print" id="option6" data-scrl="Erste Schritte, wie Sie den Energieverbrauch senken">
            <div class="left-content noalign col-md-6">
                ...
                <ul>
                    ...
                    <li>
                        Beziehen Sie Ihr Personal aktiv in Ihren Aktionsplan zum Energiesparen ein, denn das Engagement Ihrer Mitarbeitenden ist wichtig, damit Ihre Maßnahmen wirken. Sprechen Sie in regelmäßigen Abständen mit Ihren Mitarbeitenden und ermutigen Sie sie, eigene Ideen einzubringen. Führen Sie kurze Schulungen durch oder bringen Sie Hinweise an gut sichtbaren Stellen an.
                    </li>
                    <li>

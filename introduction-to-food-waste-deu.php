...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <section class="safeFoodl4_banner no-print" id="option1" data-scrl="Warum wir die Menge an Lebensmittelabfällen reduzieren müssen">
        ...
        <section class="didyouknow_contents waste_foot_l3" id="option2" data-scrl="Wussten Sie, dass…">

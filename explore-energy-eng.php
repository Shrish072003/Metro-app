...
<head>
    ...
    <meta name="description" content="Besuchen Sie die digitale METRO Plattform Mein nachhaltiges Restaurant, um Nachhaltigkeit in der HoReCa-Branche zu erkunden. Besuchen Sie">
    ...
    <meta name="og:description" content="Besuchen Sie die digitale METRO Plattform Mein nachhaltiges Restaurant, um Nachhaltigkeit in der HoReCa-Branche zu erkunden. Besuchen Sie.">
...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        ...
        <div class="page-3_stage page-4_stage plastic_waste_l4_page">
            ...
            <section class="good_to_know no-print mtcsutom energy_page" id="option2" data-scrl="Good to know">
                <div class="container">
                    <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="pageSlider-slide-text">
                                                                                    <span class="sldText08">
                                                                                        CLEAN AND MAINTAIN<br>YOUR EQUIPMENT
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12">
            ...
            <section class="safeFoodl4_banner no-print" id="option5" data-scrl="Track and talk about your progress">
                <div class="container-fluid">
                    <div class="row px-4">
                        <div class="col-md-5">
    ...
    <script>
        ...
        var fDText = "METRO Markets offers a variety of energy efficient equipment.";
        $("#footDynamicText").text(fDText);

         //like share stats
        $(document).ready(function(){
            $.ajax({
                url : 'isliked.php?q=ENERGY',
                type : 'POST',

        ...
        <section class="plastic-waste_yellow no-print" id="clickTohide">
            <div class="container-fluid">
                <div class="row bg_yellow px-5">
                    ...
                    <div class="col-md-9">
                        <h3>Der Einfluss der Gastronomie auf die Herausforderungen des Plastikmülls</h3>
                        <p>Wir müssen jetzt etwas unternehmen: Die Verschmutzung unserer Meere durch Plastikmüll hat dramatische Ausmaße angenommen. Schon heute landet im Durchschnitt jede Minute eine LKW-Ladung Plastikmüll im Meer. Ihnen sollte deshalb klar sein, dass wir sofort handeln müssen! Mit Ihrem Restaurant können Sie einen wichtigen Beitrag zur nachhaltigen Entwicklung leisten, denn Ihr Geschäftsbetrieb ist eng mit den Menschen und der Umwelt verbunden. Vielleicht fällt Ihnen der Plastikmüll in Ihrer Umgebung auf. Viele Gäste und insbesondere jüngere Generationen wollen das nicht länger tolerieren.</p>
                    </div>
                </div>
            </div>
        </section>
...
"><img src="assets/images/plastic-waste/Asset 8.svg">
                                ...
                                <tr>
                                    ...
                                    <td>Beansprucht Platz in Ihrem Abfalleimer, für den Sie möglicherweise bezahlen. Bitten Sie Ihren Lieferanten, den Abfall bei der Lieferung zurückzunehmen.</td>
        ...
        <section class="plastic-waste_goodToKnow no-print" id="option3" data-scrl="Gut zu wissen">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="plastic-waste_goodToKnow_box">
                            <img src="./assets/images/plastic-waste/Asset 15-1.svg" style="width: 71%;margin-bottom:1rem;margin-top:.5rem">
        ...
        <section class="simple_wayTo_preventing no-print desk_show" id="option4" data-scrl="Tipps für Einsteiger, um Plastikmüll zu vermeiden">
            <div class="section-div">
                <div class="container-fluid">
                    ...
                    <p class="disc">Für die Gastronomie gibt es vielfältige Möglichkeiten, um die Menge an Plastikmüll zu reduzieren. </p>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText01">
                                                                                    Vermeiden Sie die<br>Nutzung von Plastikfolie
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText02">
                                                                                    Vermeiden<br> Sie Einwegplastik
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                        <div class="pageSlider-slide-text">
                                          <span class="sldText03">
                                            Verzichten <br> Sie auf Plastikstrohhalme
                                          </span>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                                                ...
                                                                <div class="swiper-slide pageSlider-slide text-center">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-image">
                                                                                <span class="sldImg04">
                                                                                    <img src="assets/images/safe_food/pw-4.svg" class=" img-fluid german_img">
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText05">
                                                                                    Fragen Sie Ihre Gäste, <br>ob Sie Besteck benötigen
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText07">
                                                                                    Verwenden Sie Mehrweg- oder Pfandverpackungen sowie Mehrweg-Plastikbehälter
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                ...
                                                                <div class="swiper-slide pageSlider-slide text-center">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-image">
                                                                                <span class="sldImg08">
                                                                                    <img src="assets/images/safe_food/pw-8.svg" class=" img-fluid german_img2">
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText08">
                                                                                    Nutzen Sie die lokale Kunststoffsammlung und -entsorgung
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText09">
                                                                                    Nehmen Sie an Refill-Aktionen teil
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="pageSlider-slide-text">
                                                                                <span class="sldText10">
                                                                                    Legen Sie Wert auf nachhaltig verpackte Produkte
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-12">
        ...
        <section class="advance_way no-print plastic_waste_expl" id="option5" data-scrl="Tipps für Fortgeschrittene, um Plastikmüll zu vermeiden">
            <div class="container">
                <div class="row">
                    ...
                    <p>Sie können sogar noch weiter gehen, indem Sie Tipps für Fortgeschrittene zur Vermeidung von Plastikmüll anwenden: </p>
                </div>
            </div>
        </section>
                ...
                <div class="mid-content cation-plan-section">
                    <ul>
                        ...
                        <li>
                            ...
                            <p class="">Ergreifen Sie Maßnahmen zur Reduzierung Ihres Plastik- und Verpackungsmülls, indem Sie die Tipps für Einsteiger oder sogar für Fortgeschrittene anwenden

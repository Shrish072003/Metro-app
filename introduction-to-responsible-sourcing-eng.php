...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <div class="page-3_stage">
            <section class="section1 mt-4" id="option1" data-scrl="How to source products responsibly">
        ...
        <?php include "includes/scroll/scroll3_new.php"; ?>
            ...
            <section class="desk_show">
                <div class="section3-grid" id="option4" data-scrl="Benefits">
                    <ul>
                        ...
                        <li></li>
                        <li>
                            <p>Opportunity to increase profit</p>
                        </li>
                        <li></li>
                        <li>
                        ...
                        <li></li>
                        <li>
                            <p>Menu easily updated with the season</p>
                        </li>
                        <li></li>
                        <li>
                        ...
                        <li></li>
                        <li>
                            <p>Comply with upcoming regulations</p>
                        </li>
                        <li></li>
                        <li>
                            <p></p>
            ...
            <section class="section4" id="option6" data-scrl="Steps to source responsibly">
                <div class="left-content noalign w60-per p60a">
                    ...
                    <div class="read-wrap">
                        <a href="explore-responsible-sourcing-eng.php" class="read-more" target="_self">Read More</a>
                    </div>
                </div>
                <div class=" mr-4 p60b desk_show">
                    <a href="https://www.metro.de/" target="_blank">
                        <img src="assets/images/resp_sourcing/baskets.svg" class="img-fluid" />
                    </a>
                </div>

...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <section class="banner-section" id="option1" data-scrl="Die Bedeutung von Plastik in der Gastronomie">
...
" class="mt-12 px-5 h3v">
                    ...
                    <div class="col-md-6 mt-2">
                        <img src="assets/images/plastic_waste/banner-image.svg" class="mt-5 px-5 img-fluid banner-image" />
                    </div>
        ...
        <section class="desk_show" id="option4" data-scrl="Vorteile">
            <div class="section3-grid">
                <ul>
                    ...
                    <li></li>
                    <li>
                        <p>Weniger Abfall, niedrigere Kosten</p>
                    </li>
                    <li></li>
                    <li>
                        <p>Einhaltung von gesetzlichen Vorschriften</p>
                    </li>
                    <li></li>
                    <!-- </ul><ul> -->
                    <li></li>
                    ...
                    <li></li>
                    <li>
                        <p>Einsparung von natürlichen Ressourcen</p>
                    </li>
                </ul>
            </div>
        </section>
        ...
        <section id="option5" data-scrl="Ein gesellschaftlicher Trend">
            <div class="section3-inner3 align-normal section3-inner3-bit">
                <div class="left-content">
            ...
            <div class="container-full">
                <div class="row">
                    <div class="col-md-7 mt-2 mb-2 px-5 b-right">
                        ...
                        <div class="col-md-5 mt-2 mb-2 just-center mobile_show">
                        ...
                        <div class="read-wrap">
                            <a href="explore-plastic-waste-deu.php" class="read-more">WEITERLESEN</a>
                        </div>
                    </div>
                    <div class="col-md-5 mt-2 mb-2 just-center desk_show">
                        <img src="assets/images/plastic_waste/earth-recycle.svg" class="img-fluid heirarchy-image mx-3 my-auto" />
                    </div>
                </div>
            </div>

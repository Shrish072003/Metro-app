        ...
        <div class="page-3_stage page-4_stage">
            ...
            <section class="section1 no-print" id="option1" data-scrl="Wie Sie sich als Gastronomiebetreibende sozial engagieren können">
                ...
                <div class="right-content no-print">
                    <img src="./assets/images/safe_food/s-1.svg" class="img-fluid mt-4" />
                </div>
            ...
            <section class="soFood_importants no-print" id="clickTohide">
                ...
                <div class="container-fluid px-3">
                    <div class="row bg_yellow mt-3">
                        <div class="col-md-4">
                            <img src="./assets/images/safe_food/s-2.svg" class="img-fluid mt-5 px-2">
                        </div>
                        <div class="col-md-8 mt-3 px-3">
                            ...
                            <p class="two-column justify1">
                                ...
                                <br>
                                Als Gastronomin oder Gastronom haben Sie eine unmittelbare Verantwortung für Ihre Mitarbeitenden. Darüber hinaus haben Sie auch eine indirekte Verantwortung für jeden Arbeitnehmenden in der Lieferkette, der Sie mit Produkten versorgt – sei es die Landwirtin oder der Landwirt oder die Fahrerin bzw. der Fahrer. Ein sozial engagierter Gastronomiebetreibender zu sein, bedeutet daher, sich auch vor Ort in der eigenen Region angemessen zu verhalten, z. B. gegenüber anderen Gastronomiebetreibenden, Verbänden und Wohltätigkeitsorganisationen. Insbesondere in extrem herausfordernden Zeiten kann die Art und Weise, wie Sie Ihr Personal und Ihre Lieferanten behandeln oder wie Sie mit Ihrer Kommune interagieren, nicht nur für Sie positive Auswirkungen haben, sondern Sie auch beeinflussen und damit auch grundsätzlich das Verständnis von guter Arbeit in der Gastronomie.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="good_to_know no-print social_box" style="padding-bottom: 12rem;" id="option2" data-scrl="Gut zu wissen">
                <div class="container">
                    ...
                    <div class="col-md-4 px-4 mobile_show">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-4">
                                <img src="./assets/images/safe_food/s-4.svg" class="img-fluid">
                    ...
                    <div class="row margin_top">
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-4">
                                <img src="./assets/images/safe_food/s-20.svg" class="img-fluid">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-4">
                                <img src="./assets/images/safe_food/s-5.svg" class="img-fluid">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-4">
                                <img src="./assets/images/safe_food/s-6.svg" class="img-fluid">
            ...
            <section class="simple_wayTo_preventing no-print social_l4_yellow_slider pt-5" id="option3" data-scrl="Die 7 Grundrechte" style="padding-bottom: 10rem;background: #ffe500;margin-top: 0;">
...
<?php include "includes\scroll_deu\bigscroll6_deu.php"; ?>
            ...
            <section class="three-step_food_safety no-print" id="option4" data-scrl="Wege, um sich als Gastronomin oder Gastronom sozial zu engagieren">
...
<iframe src="includes/scroll_deu/bigscroll7_deu.php" height="430px"></iframe>
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        <div>
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="img-holder1">
                                                                    <div class="img-holder1-inner">
                                                                        <img src="./assets/images/safe_food/s-7.svg" class="tabc-image1">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg01">
                                                                                                        <img src="assets/images/safe_food/s-8.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg02">
                                                                                                        <img src="assets/images/safe_food/s-9.svg" class="img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg03">
                                                                                                        <img src="assets/images/safe_food/s-10.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg21">
                                                                                                        <img src="assets/images/safe_food/s-12.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg22">
                                                                                                        <img src="assets/images/safe_food/s-13.svg" class="img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg23">
                                                                                                        <img src="assets/images/safe_food/s-14.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg24">
                                                                                                        <img src="assets/images/safe_food/s-15.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg31">
                                                                                                        <img src="assets/images/safe_food/s-17.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg32">
                                                                                                        <img src="assets/images/safe_food/s-18.svg" class="img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
                                                                                    ...
                                                                                    <div class="swiper-slide pageSlider-slide text-center">
                                                                                        <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <div class="pageSlider-slide-image">
                                                                                                    <span class="sldImg33">
                                                                                                        <img src="assets/images/safe_food/s-19.svg" class=" img-fluid">
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-12">
            ...
            <section class="container section4-6 section-to-print" id="option6" data-scrl="Ihr Aktionsplan">
                ...
                <div class="mid-content cation-plan-section">
                    <ul>
                        <li>
                            ...
                            <p class="">Informieren Sie sich über die nationale Gesetzgebung zu den Arbeitsbedingungen und zu den sieben Grundrechten, die von der UN definiert wurden</p>
                        </li>
                        <li>
                            <label class="check-wrap">
                                <input type="checkbox" checked="checked">
                            ...
                            <p class="">Beziehen Sie Ihr Personal und Ihre Lieferanten mit ein</p>
                        </li>
                        <li>
                            <label class="check-wrap">
                                <input type="checkbox" checked="checked">
    ...
    <script>
        ...
        //page params
        $(document).ready(function() {
            var cur_page_name = "Gemeinschaft";
            var cur_nav_link_id = "3";
            var eng_page_path = "explore-social-eng.php";
            var deu_page_path = "explore-social-deu.php";
            //manipulation
        ...
        var fDText = "METRO bietet Ihnen Beratungen durch METRO-Mitarbeitende an. Eine Referenz finden Sie unter METRO Faire Arbeitsbedingungen.";
        $("#footDynamicText").html(fDText);

         //like share stats
        $(document).ready(function(){
            $.ajax({
                url : 'isliked.php?q=Gemeinschaft',
                type : 'POST',
            ...
            $.ajax({
                ...
                success : function (result) {
                    ...
                    if(retVal>0){
                        //dislike
                        $.ajax({
                            url : 'dislike.php?q=Gemeinschaft',
                            type : 'POST',
                            success : function (result) {
                                var retVal=parseInt(result);
                                if(retVal="1"){

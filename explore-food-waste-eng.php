...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <section class="safeFoodl4_banner no-print" id="option1" data-scrl="How to reduce food waste">
        ...
        margin-left: auto;" >
                    ...
                    <div class="col-md-5 offset-md-1 no-print">
                        <div class="banner_l4_img">
                            <img src="assets/images/safe_food/Asset 1.svg" class="img-fluid pl-5 desk-show" style="width:80%;float:right;">
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <section class="good_to_know no-print mtcsutom" id="option2" data-scrl="Landfills should be the last place for food waste">
            <div class="container">
                <div class="row">
                    ...
                    <div class="benefit_box benefit_box_desk" >
                            <h4>Benefits of reducing food waste are enormous</h4>
                        </div>
                        <div class="good_to_know_box p-4 safe_foodBox_l4 margin-top-imgg">
        ...
        <section class="yellow-sec1" id="option3" data-scrl="Good to know">
        ...
        <section class="advance_way no-print" id="option5" data-scrl="Advanced ways to reduce food waste">
            <div class="container">
                <div class="row">
        ...
        <section class="compost_wasteFood pb-3 no-print">
            <div class="container-fluid">
                <div class="row px-4">
                    ...
                    <img src="assets/images/safe_food/Asset 32.svg" class="img-fluid downimgdownimg" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="compost_wasteFood_listing">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <p class="mt-3">Decide if you will compost on-site or use a removal service</p>
                                </div>
                            </div>
                        </div>
                        <div class="compost_wasteFood_listing">
                        ...
                        <div class="compost_wasteFood_listing">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <p class="mt-3">Consider using more eco-friendly disposables, for example, rubbish bin liners</p>
                                </div>
                            </div>
                        </div>
                        <div class="compost_wasteFood_listing">
        ...
        <section class="compost_wasteFood pb-5 no-print" id="option6" data-scrl="Leran to make more out of food scraps">
            <div class="container-fluid">
                <div class="row px-4">
                    ...
                    <p class="text-center downimg">Check out the following aspects when you want to cook with unwanted parts:</p>
                    <div class="col-md-6">
                        <div class="compost_wasteFood_img learn_to_make ">
                            ...
                            <br>
                            <p class="text-center downimgdownimg">Check out the following aspects when you want to cook with unwanted parts:</p>
                            <center class="mt-5">
        ...
        <section class="safeFoodl4_banner no-print" id="option7" data-scrl="Track and talk about your progress">
            <div class="container-fluid">
                <div class="row px-4">
                    <div class="col-md-5">
                        <div class="banner_l4_title">
                            <h1 class="banner_title2">Track and Talk <br>About Your Progress </h1>
                            <div class="col-md-5 offset-md-1 downimgdownimg">
                    ...
                    <div class="col-md-5 offset-md-1 downimg">
                        <div class="banner_l4_img talk_prog_img">
                            <img src="assets/images/safe_food/Asset 44.svg" class="img-fluid pl-5">
                        </div>
                    </div>
        ...
        <section class="action_plan mt-5 section-to-print" id="option8" data-scrl="Your action plan">
            <div class="container">

...
<section>
    ...
    <ul class="section-lena-inner" id="accordion9">
        ...
        <!---------ADVANCE WAYS---------->
        <section class="section-highlight-withimages section4-5 pbg mb-3 no-print" id="option7" data-scrl="Advanced ways to source responsibly">

...
<body class="popup-exists page-animation1">
    ...
    <div class="wrapper">
        <div class="page-3_stage page-4_stage">
            ...
            <section class="good_to_know no-print" id="option2" data-scrl="Good to know">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-1">
                                ...
                                <p>Good quality products were the second most important consideration for HoReCa customers globally, according to METRO’s sustainability survey 2019. </p>
                            </div>
                        </div>
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-1">
                                <img src="assets/images/safe_food/Asset 8.png" class="img-fluid">
                                <p>Getting sick from food is called foodborne disease. This is caused by dangerous microorganisms and/or toxic chemicals. The disease is a problem in both developing and developed countries, causing a strain on health care systems and hurting the economy. It can happen at home and while eating out. Most foodborne diseases are preventable with proper food handling. </p>
                            </div>
                        </div>
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-1">
                                <img src="assets/images/safe_food/Asset 37.png" class="img-fluid">
                                <p>Contaminated food can have many causes. Dirty hands is one of the most common ways food is contaminated and contamination can occur right from the areas where you receive your food through delivery, your employees, and your equipment. </p>
                            </div>
                        </div>
                    </div>
                    <div class="row margin_top">
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-1">
                                ...
                                <p>Authorities in some countries have introduced food safety rating schemes that make hygiene inspection results public. Consumers can find the score of their local restaurant and decide whether to eat there or not. In some countries, these scores are published on the door of the restaurant. In others, you can look it up online before eating out.</p>
                            </div>
                        </div>
                        <div class="col-md-4 px-4">
                            <div class="good_to_know_box p-1">
            ...
            <section class="three-step_food_safety no-print" id="option3" data-scrl="Three steps to food safety">
                <div class="container-fluid px-4">
                    <div class="row">
                        <h3>Three steps to food safety</h3>
                        <div class="col-md-6">
                            <div class="step_safty_para">
                                <p>Safe food is the foundation of a sustainable restaurant. Keeping food safe doesn’t have to be complicated although there are different levels to which your business can operate. The first step is to have a food safety management system. On top of this is HACCP (Hazard Analysis Critical Control Points) which is a legal requirement in many, but not all countries. </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="step_safty_para">
      ...
      <div class="accordion-content">
        ...
        <div class="row">
          <div class="col-md-12 mb-5">
            ...
            <section class="track-and_talk no-print" id="option4" data-scrl="Track and talk about your progress">
            ...
            <section class="container section4-6 section-to-print" id="option5" data-scrl="Your action plan">
                ...
                <div class="mid-content cation-plan-section">
                    <ul>
                        <li>
                            ...
                            <p class=""> Understand that safe food is the core of your business </p>
                        </li>
                        <li>
                            <label class="check-wrap">
                                <input type="checkbox" checked="checked">
                            ...
                            <p class=""> Implement a Food Safety Management System (FSMS) </p>
                        </li>
                        <li>
                            <label class="check-wrap">
                                <input type="checkbox" checked="checked">

    ...
    <div class="wrapper">
        <div class="container-full">
            <div class="page-3_stage page-4_stage">
                <!--BANNER-->
                <section class="section1 no-print" id="option1" data-scrl="How to engage socially as a restaurateur">
            ...
            <section class="simple_wayTo_preventing no-print social_l4_yellow_slider pt-5" style="padding-bottom: 10rem;background: #ffe500;margin-top: 0;" id="option3" data-scrl="The 7 basic human rights">
...
<?php include "includes/scroll/bigscroll6.php"; ?>
            ...
            <section class="three-step_food_safety no-print" id="option4" data-scrl="Ways to be socially engaged as a restaurateur">

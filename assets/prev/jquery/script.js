...
// logo 
    ...
    const canvas = document.getElementById('cta__logo');
    const ctx = canvas.getContext('2d');
   
    vv = canvg.Canvg.fromString(ctx,'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 234.6 69.9" width="180" height="58" class="cta__logo">'+
                    '<polygon points="106.2 19 93.6 19 84.1 28.5 106.2 19" style="fill:#e94b5a"></polygon>'+
                    '<polygon points="93 0 84.1 8.9 84.1 22.4 93 0" style="fill:#16345f"></polygon>'+
                    '<path d="M77.8,43.4l3.9-5.2A19.12,19.12,0,0,0,77,35.6l-5.9,5.9a3.51,3.51,0,0,1,1.6-.3A10.94,10.94,0,0,1,77.8,43.4Z" style="fill:#16345f"></path>'+
                    '<path d="M73.5,53.6c0,1-.7,1.5-2.5,1.5a10.82,10.82,0,0,1-6.2-2.5L60.9,58a17.13,17.13,0,0,0,9.9,3.6c7.1,0,10.9-3.7,10.9-8.4s-3.5-6.5-6.5-7.6c-2.5-.9-4.8-1.4-4.8-2.7,0-.3,0-.5.1-.6l-6.1,6.1a11.44,11.44,0,0,0,4.2,2.5C71.2,51.7,73.5,52.3,73.5,53.6Z" style="fill:#16345f"></path>'+
                    '<path d="M99.9,34.9a11,11,0,0,0-8,3.7h-.2l-.6-3.1H84V60.9h8.7V44.2c1.3-1.2,2.2-1.9,3.9-1.9s2.5.8,2.5,4.1V60.9h8.7V45.2C107.8,38.9,105.4,34.9,99.9,34.9Z" style="fill:#16345f"></path>'+
                    '<path d="M122.4,34.9a21,21,0,0,0-11.2,3.4l3.1,5.7c2.6-1.4,4.6-2.1,6.4-2.1,2.2,0,3.4.8,3.6,2.6-9.8,1-13.8,4-13.8,9.3,0,4.2,2.8,7.8,7.6,7.8a10,10,0,0,0,7-3.1h.2l.6,2.4H133V46.8C133,38.4,129,34.9,122.4,34.9Zm1.9,18.2a4,4,0,0,1-3.2,1.7c-1.5,0-2.3-.7-2.3-1.8,0-1.4,1.3-2.7,5.5-3.4Z" style="fill:#16345f"></path>'+
                    '<path d="M151.5,34.9a10.71,10.71,0,0,0-6.9,2.9h-.2l-.6-2.3h-7.1V69.9h8.7v-7l-.3-3.9a8.06,8.06,0,0,0,5.7,2.5c5.4,0,10.6-5,10.6-13.7C161.4,40,157.5,34.9,151.5,34.9Zm-2.8,19.5a5,5,0,0,1-3.3-1.2V43.8a4.22,4.22,0,0,1,3.5-1.8c2.3,0,3.6,1.7,3.6,5.9C152.4,52.8,150.7,54.4,148.7,54.4Z" style="fill:#16345f"></path>'+
                    '<path d="M179,34.9a10.71,10.71,0,0,0-6.9,2.9h-.2l-.6-2.3h-7.1V69.9h8.7v-7l-.3-3.9a8.06,8.06,0,0,0,5.7,2.5c5.4,0,10.6-5,10.6-13.7C188.9,40,185,34.9,179,34.9Zm-2.9,19.5a5,5,0,0,1-3.3-1.2V43.8a4.22,4.22,0,0,1,3.5-1.8c2.3,0,3.6,1.7,3.6,5.9C179.9,52.8,178.2,54.4,176.1,54.4Z" style="fill:#16345f"></path>'+
                    '<path d="M202.5,34.9c-6.2,0-12.2,5.1-12.2,13.3,0,8.4,5.7,13.3,13.1,13.3a17.75,17.75,0,0,0,9.3-2.9l-2.8-5.2a10.61,10.61,0,0,1-5.2,1.5c-2.8,0-5.1-1-5.9-4.1h14.4a14.55,14.55,0,0,0,.4-3.7C213.6,40.4,210,34.9,202.5,34.9Zm-3.9,10.2c.5-2.5,2.1-3.7,4.1-3.7,2.6,0,3.5,1.7,3.5,3.7Z" style="fill:#16345f"></path>'+
                    '<path d="M224.3,39.9h-.2l-.6-4.4h-7.1V60.9h8.7V46.8c1.2-3.2,3.5-4.3,5.3-4.3a11.8,11.8,0,0,1,2.8.4l1.4-7.5a7.81,7.81,0,0,0-3.2-.5C229,34.9,226.1,36.4,224.3,39.9Z" style="fill:#16345f"></path>'+
                    '<path d="M39.9,28.4c-1.9,0-3.6,1.1-4.1,3.7h7.5C43.3,30.1,42.5,28.4,39.9,28.4Z" style="fill:none"></path>'+
                    '<path d="M11.9,21.7H8.7v8.1h3.2c3.5,0,5.3-1.5,5.3-4.4S15.4,21.7,11.9,21.7Z" style="fill:none"></path>'+
                    '<path d="M61.3,35c0,4.6,1.4,6.3,3.8,6.3a3.67,3.67,0,0,0,3.3-1.8V30.1a5.15,5.15,0,0,0-3.5-1.2C63.1,28.9,61.3,30.5,61.3,35Z" style="fill:none"></path>'+
                    '<path d="M11.9,21.7H8.7v8.1h3.2c3.5,0,5.3-1.5,5.3-4.4S15.4,21.7,11.9,21.7Z" style="fill:none"></path>'+
                    '<path d="M20.4,35c3.2-1.7,5.3-4.8,5.3-9.6,0-8.2-6.1-10.7-13.2-10.7H0V47.8H8.7V36.7h3.4l5.7,11.1h9.8Zm-8.5-5.2H8.7V21.7h3.2c3.5,0,5.3.9,5.3,3.8S15.4,29.8,11.9,29.8Z" style="fill:#e94b5a"></path>'+
                    '<path d="M50.8,34.1c0-6.8-3.6-12.3-11.1-12.3-6.2,0-12.2,5.1-12.2,13.3,0,8.4,5.7,13.3,13.1,13.3a17.75,17.75,0,0,0,9.3-2.9l-2.8-5.2a10.61,10.61,0,0,1-5.2,1.5c-2.8,0-5.1-1-5.9-4.1H50.5C50.5,37.1,50.8,35.6,50.8,34.1ZM35.8,32c.5-2.5,2.1-3.7,4.1-3.7,2.6,0,3.5,1.7,3.5,3.7Z" style="fill:#e94b5a"></path>'+
                    '<path d="M68.4,12.4v8.2l.3,3.7a7.72,7.72,0,0,0-5.9-2.5c-5.2,0-10.4,5-10.4,13.3s4.1,13.3,10.4,13.3a10,10,0,0,0,1.6-.2L77.2,35.4V12.3H68.4Zm0,27.1a3.48,3.48,0,0,1-3.3,1.8c-2.3,0-3.8-1.7-3.8-6.3s1.7-6.1,3.6-6.1a5.5,5.5,0,0,1,3.5,1.2v9.4Z" style="fill:#e94b5a"></path>'+
                  '</svg>');
vv.start();

// father girl

 const father_girl = document.getElementById('father-girl');
    const fg_ctx = father_girl.getContext('2d');
    fg_vv = canvg.Canvg.fromString(fg_ctx, '<svg xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:svg="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" inkscape:version="1.0.2-2 (e86c870879, 2021-01-15)" sodipodi:docname="father-gal.svg" x="0px" y="0px" viewBox="0 0 29.3 72.3" enable-background="new 0 0 29.3 72.3" xml:space="preserve"><metadata id="metadata105"><rdf:rdf><cc:work rdf:about=""><dc:format>image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage"></dc:type><dc:title></dc:title></cc:work></rdf:rdf></metadata><defs id="defs103"></defs>'+

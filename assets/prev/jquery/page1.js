...
$('.article__close,.btn-changing').click(function(){
$('.overlay,.article--home').hide();
$('body').removeClass('popup-exists');
$( "#draggable" ).draggable();
})
$(document).tooltip({
          content: function () {
...
$(document).ready(function(){
  ...
  var divHeight = $(".collapsible__header").height();
$(".collapsible__header").height(divHeight);

var imgHeight = $(".drag-image").height();
$(".image-drag, .image-drag .wrapper, .image-drag .container-wrap").height(imgHeight);

});

$(document).on('click','.sec-banner', function(){
$(this).find(".tooltip_wrapper").addClass("active");
// alert('gghjh');
})

$(document).on('click','.popup__close', function(){
var $tooltip = $(this).closest(".tooltip_wrapper");
	setTimeout(function(){
	    $tooltip.removeClass("active");
	console.log('gghjh',$tooltip.length, $tooltip.attr('class'));
	},200);
});
